...
try{
	...
	dCasperSports.run(function () {
		...
		if(fs.exists("/projects/GiantEagle/webcrawler/daum/mobile_crwl/m_daum_spo_article_url.in")){
      fs.remove("/projects/GiantEagle/webcrawler/daum/mobile_crwl/m_daum_spo_article_url.in");
    }
    var articleStream = fs.open("/projects/GiantEagle/webcrawler/daum/mobile_crwl/m_daum_spo_article_url.in", 'w');
    for(i  = 0; i < il; i++){
